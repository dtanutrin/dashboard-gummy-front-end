          ...
          {user && (
            <div className="flex items-center">
              ...
              {user.role === "Admin" && (
                <div className="mr-4">
                  <Link href="/admin">
                    {/* AJUSTE BOTÃO MOBILE v2: Removido w-8 h-8, mantido p-2, SVG com flex-shrink-0 */}
                    <button className="flex items-center justify-center border border-pink-200 text-pink-700 hover:bg-pink-50 hover:text-pink-800 dark:border-pink-800 dark:text-pink-300 dark:hover:bg-pink-900 dark:hover:text-pink-200 p-2 sm:px-3 sm:py-2 rounded-md">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 22 22" strokeWidth="1.6" stroke="currentColor" className="w-6 h-6 flex-shrink-0"> {/* Mantido w-5 h-5, adicionado flex-shrink-0 */}
