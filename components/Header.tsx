          ...
          {user && (
            <div className="flex items-center">
              ...
              {user.role === "Admin" && (
                <div className="mr-4">
                  <Link href="/admin">
                    {/* AJUSTE BOTÃO MOBILE v3: Aumentado tamanho do SVG para w-6 h-6 */}
                    <button className="flex items-center justify-center border border-pink-200 text-pink-700 hover:bg-pink-50 hover:text-pink-800 dark:border-pink-800 dark:text-pink-300 dark:hover:bg-pink-900 dark:hover:text-pink-200 p-2 sm:px-3 sm:py-2 rounded-md">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-7 flex-shrink-0"> {/* Aumentado para w-6 h-6 */}
              ...
              <div className="mr-4">
                <Link href="/user-profile">
                  {/* AJUSTE BOTÃO MOBILE v3: Aumentado tamanho do SVG para w-6 h-6 */}
                  <button className="flex items-center justify-center border border-pink-200 text-pink-700 hover:bg-pink-50 hover:text-pink-800 dark:border-pink-800 dark:text-pink-300 dark:hover:bg-pink-900 dark:hover:text-pink-200 p-2 sm:px-3 sm:py-2 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 flex-shrink-0"> {/* Aumentado para w-6 h-6 */}
