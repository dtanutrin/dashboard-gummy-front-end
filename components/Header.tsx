          ...
          {user && (
            <div className="flex items-center">
              ...
              {user.role === "Admin" && (
                <div className="mr-4">
                  <Link href="/admin">
                    {/* AJUSTE BOTÃO MOBILE v4: Removido padding p-2 do botão, mantido SVG w-6 h-6 */}
                    <button className="flex items-center justify-center border border-pink-200 text-pink-700 hover:bg-pink-50 hover:text-pink-800 dark:border-pink-800 dark:text-pink-300 dark:hover:bg-pink-900 dark:hover:text-pink-200 sm:px-3 sm:py-2 rounded-md"> {/* Removido p-2 */}
